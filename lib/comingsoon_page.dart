...
import 'package:bidouille_tmdb_flutter_tmp/widgets/custom_app_bar.dart';
...
class ComingMovies extends StatefulWidget {
  ...
  @override
  _ComingMovies createState() => _ComingMovies();
}

class _ComingMovies extends State<ComingMovies> {
  Future<bool>? _data;

  final String _movieApiKey = 'xxxx';
  final _accessToken = 'xxxx';
  ...
  Future<bool> _fetchDataDebug() async {
    ...
    try {
      ...
      UserCredential userCredential = await _auth.signInWithEmailAndPassword(
          email: "xxx@gmail.com", password: "xxxxxx");
      ...
      Map trendingResults = await tmdbLogs.v3.movies.getUpcoming();
